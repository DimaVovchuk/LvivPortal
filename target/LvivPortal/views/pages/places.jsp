    ...
    <div class="match-col col l4 m6 s12">
        <div class="card z-depth-2" style="padding:10px; height:95%">
            <c:if test="${userDataTrip!=null}">
                ...
                <a class="btn-on-img modal-trigger btn-floating btn-large waves-effect waves-light cyan darken-2"
                   data-target="chooseDayRecomended"
            ...
            <div class="center-align">
                ...
                <c:if test="${login!=null}">
                    ...
                    <div class="bottom-right-btn">
                        <a onClick="like(this);" data-id="{{id}}" data-rating="{{rating}}" id="up{{id}}"
                           class="up{{id}} btn-floating btn-floating btn-small"
                           href="javascript:" rel="/portal?command=rectRating&rating=1&place_id={{id}}">
                            <i class="material-icons">thumb_up</i>
                        </a>

                        <a onClick="none(this);" data-id="{{id}}" id="none{{id}}"
                           class="none{{id}} btn-floating btn-floating btn-small"

...
<script>
    ...
    var updatePlaces = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var buttons = '<a href="/portal?command=editPlace&editPlaceID=' + data[i].id + '&custom=confirm" class="btn cyan darken-2 waves-effect waves-light" style="margin-right: 5px"><cdg:l18n key="admin.edit.places.confirm"/></a>' +

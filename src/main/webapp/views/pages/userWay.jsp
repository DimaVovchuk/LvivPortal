    ...
    <div class="match-col col l4 m6 s9" style="display:none">
        <div class="card z-depth-2" style="padding:10px; height:95%">
                ...
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator"
                        src="${pageContext.request.contextPath}/upload/photo/${day.imageReference}"
                        style="width: 100%">
                </div>
                <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4"><div align="center"><h5><cdg:l18n key="day.number"/> - ${day.day}</h5></div></span>
                </div>
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4"><cdg:l18n key="day.number"/> - ${day.day}</span>
                    <p>

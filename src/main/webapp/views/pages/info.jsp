			...
			<div class="col l9 m8 s7">
					...
					<div class="section">
						...
						<c:if test="${login!=null}">
							<div class="bottom-right-btn form" id="like-place-info" align="right">
								<a onClick="like(this);" data-id="${placeDescription.place_id}" data-rating="${rating}"
								   id="up" class="up btn-floating btn-floating btn-small"
								   href="javascript:"
								   rel="/portal?command=rectRating&rating=1&place_id=${placeDescription.place_id}">
									<i class="material-icons">thumb_up</i>
								</a>

								<a onClick="none(this);" data-id="${placeDescription.place_id}" id="none"
								   class="none btn-floating btn-floating btn-small"
								   href="javascript:"
								   rel="/portal?command=rectRating&rating=0&place_id=${placeDescription.place_id}">
									<i class="material-icons">thumbs_up_down</i>
								</a>

								<a onClick="dislike(this);" data-id="${placeDescription.place_id}" id="down"
				...
				<c:if test="${sessionScope.login != null}">
					<a class="waves-effect waves-light btn modal-trigger cyan darken-2"
					   href="javascript:" rel="/portal?command=savePlace&place_id=${place_id}"
					   onClick="addToFavorite(this);"><cdg:l18n key="place.favorite"/></a>
				</c:if>
				<c:if test="${sessionScope.role == 1 or sessionScope.checkCustomEditID != 0}">

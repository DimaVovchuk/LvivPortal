		...
		<div class="col l8 offset-l2 m10 offset-m1 s12 z-depth-2">
			...
			<div class="row">
				...
				<div class="col l8 m7 s6">
					...
					<p>
						<a class="btn waves-effect waves-light cyan darken-2 modal-action modal-close modal-trigger"
						   href="#orderWayModel"
		...
		<form name="image-send-comment" id="image-send-comment" action="" method="post">
			<div class="input-field">
				<input id="image_id" name="image_id" type="hidden"/>
					<textarea name="gallery-comment" id="gallery-comment" class="materialize-textarea"
					          value=""></textarea>

...
public class MySqlWayResponseDao extends AbstractJDBCDao<WayResponse, Integer> {
    ...
    Class<WayResponse> clazz;
    Transformer<WayResponse> transformer = new Transformer<>(WayResponse.class);

    private class PersistGroup extends WayResponse {
    ...
    @Override
    public WayResponse create(WayResponse obj) throws PersistException {
        return persist((WayResponse)obj);
    }
    ...
    @Override
    protected List<WayResponse> parseResultSet(ResultSet rs) throws PersistException {
        List<WayResponse> result = new LinkedList<WayResponse>();
        result = transformer.rowToObject(rs);
        return result;
    }

    @Override
    protected String prepareStatementForInsert(WayResponse object) throws PersistException{
    ...
    @Override
    protected String prepareStatementForUpdate(WayResponse object) throws PersistException {

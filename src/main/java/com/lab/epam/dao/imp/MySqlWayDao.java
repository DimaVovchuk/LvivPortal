...
public class MySqlWayDao extends AbstractJDBCDao<Way, Integer> {
    ...
    Class<Way> clazz;
    Transformer<Way> transformer = new Transformer<>(Way.class);
    ...
    @Override
    public Way create(Way obj) throws PersistException {
        return persist((Way)obj);
    }

    public MySqlWayDao(ConnectionPool connection) {
        super(connection);
    }

    @Override
    protected List<Way> parseResultSet(ResultSet rs) throws PersistException {
        List<Way> result = new LinkedList<Way>();
        result = transformer.rowToObject(rs);
        return result;
    }

    @Override
    protected String prepareStatementForInsert(Way object) throws PersistException{
    ...
    @Override
    protected String prepareStatementForUpdate(Way object) throws PersistException {

...
public class MySqlUserDao extends AbstractJDBCDao<User, Integer> {
    ...
    @Override
    public User create(User obj) throws PersistException {
        return persist((User)obj);
    }
    ...
    @Override
    protected String prepareStatementForInsert(User object) throws PersistException{
    ...
    @Override
    protected String prepareStatementForUpdate(User object) throws PersistException {

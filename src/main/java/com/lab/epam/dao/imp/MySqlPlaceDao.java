...
public class MySqlPlaceDao extends AbstractJDBCDao<Place, Integer> {
    ...
    Class<Place> clazz;
    Transformer<Place> transformer = new Transformer<>(Place.class);
    ...
    @Override
    public Place create(Place obj) throws PersistException {
        return persist((Place)obj);
    }
    ...
    @Override
    protected List<Place> parseResultSet(ResultSet rs) throws PersistException {
    ...
    @Override
    protected String prepareStatementForInsert(Place object) throws PersistException{
    ...
    @Override
    protected String prepareStatementForUpdate(Place object) throws PersistException {
